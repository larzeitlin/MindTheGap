...
def main():
  ...
  plistpath = scriptpath + "/resources/MindTheGap-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MindTheGap-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MindTheGap-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MindTheGap-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MindTheGap-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MindTheGap-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/MindTheGap-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/MindTheGap.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MindTheGap.iss",inplace=1):
